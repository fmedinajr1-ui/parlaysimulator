    ...
    const session = await stripe.checkout.sessions.create({
      ...
      custom_text: {
        terms_of_service_acceptance: {
          message: "By subscribing, you agree to a 3-day free trial. A $50 card authentication hold will be charged now. Your card will be charged $99.99/mo after the trial unless you cancel.",
        },
      },
      subscription_data: {
        trial_period_days: 3,
