    ...
    return enrichedSpots
      .map((s) => {
        ...
        return {
          ...
          allBookLines,
          closestLine: spotLiveData?.closestLine,
          closestBookmaker: spotLiveData?.closestBookmaker,
          closestDelta: spotLiveData?.closestDelta,
          isScanning: spotLiveData?.isScanning,
          pOver,
          pUnder,
          edgeScore,
